"""
sleep_kit.config
配置中心：存储所有数据集的通道映射表和文件解析规则。
"""

# ==============================================================================
# 1. 通道映射表 (Source: config.py chnNameTable)
# ==============================================================================
CHANNEL_MAPPING = {
    ...
    'SHHS2':{'C4':'EEG', 'C3':('EEG(sec)', 'EEG2'),
            'E1':'EOG(L)','E2':'EOG(R)'},
    'CCSHS':{'E1':'LOC', 'E2':'ROC', 'M1':'A1', 'M2':'A2', 'EMG':'EMG1', 'EMGref':'EMG2'},
    'SOF':{'E1':'LOC', 'E2':'ROC', 'M1':'A1', 'M2':'A2',
            'EMG':('L Chin', 'EMG/L'), 'EMGref':('R Chin','EMG/R')},
    ...
    # == MNC ==
    'SSC':{'EMG':('cchin_l','chin','cchin'), 'EMGref':('rchin_c','lchin')},
    'CNC':{'EMG':('cchin_l','chin','cchin'), 'EMGref':('rchin_c','lchin')},
    'DHC':{'EMG':('cchin_l','chin','cchin'), 'EMGref':('rchin_c','lchin')},
    # == Others ==
    ...
    'MASS13':{'F3':('EEG F3-CLE', 'EEG F3-LER'),'F4':('EEG F4-CLE', 'EEG F4-LER'),
            'C3':('EEG C3-CLE', 'EEG C3-LER'),'C4':('EEG C4-CLE', 'EEG C4-LER'),
            'O1':('EEG O1-CLE', 'EEG O1-LER'),'O2':('EEG O2-CLE', 'EEG O2-LER'),
            'E1':'EOG Left Horiz','E2':'EOG Right Horiz',
            'M1':'EEG A1-CLE', 'M2':'EEG A2-CLE',
            'EMG':'EMG Chin1', 'EMGref':'EMG Chin2'},
    'STAGES':None,
    ...
    'ISRC':{'C3':'C3-A2','C4':('C4-A1','C4-A2'),'O1':'O1-A2','O2':('O2-A1','O2-A2'),
            'E1':'LOC-A2','E2':('ROC-A1','ROC-A2'),'EMG':'EMG1-EMG2' },
}

# ==============================================================================
# 2. 数据集规则 (Source: config.py cfgData)
# ==============================================================================
# 这里的 reader 对应 annotation.py 中的函数名
DATASET_RULES = {
    ...
    'ISRC':   {'fmt_psg': 'edf', 'fmt_anno': 'STA', 'reader': None}, # ISRC anno reader missing in original
